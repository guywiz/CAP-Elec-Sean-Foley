...
Il faut être à l'aise pour lire, comprendre et interpréter un texte, et aussi écrire un court texte avec quelques idées et un peu de style.

J'avais réussi à dénicher trois sujets de l'année 2024 (probablement différents selon les régions, métropole ou outre-mer ?)

- [Sujet1 de la session de 2024](./2024_francais_ecrit_CAP_Camus.pdf) (texte de Albert Camus + image)
- [Sujet1 de la session de 2024](./2024_francais_ecrit_CAP_Foenkinos.pdf) (texte de David Foenkinos + image)
- [Sujet1 de la session de 2024](./2024_francais_ecrit_CAP_Isabelle_Carre.pdf) (texte de Isabelle Carré + image)
...
- [Mon texte (aide-mémoire) pour la présentation](./Trame_oral_français.pdf)

### Oral de Histoire-géographie et enseignement moral et civique 

C'est peut-être l'épreuve qui m'a demandé le plus de préparation.

Ca vaut la peine de regarder quelques vidéos de cette prof [Juline Anquetin Rault](https://www.youtube.com/@JulineAnquetinRault). Il faut rechercher ses vidéos comme ["ORAL CAP Histoire-Géographie-EMC"](https://www.youtube.com/watch?v=WVzZZEf4SME).

L'épreuve demande de préparer 8 sujets sur 8 thèmes différents. Le jour "J", le jury choisit un thème parmi les 8 qu'on propose. [Voir le texte officiel](./Epreuve_histoire_geographie_description.pdf). [Ou encore cette fiche de synthèse](./Tableau_synthese_modalites_evaluation_oral_CAP.jpg).

Les 8 thèmes portent soit sur histoire (H1, H2), géographie (G1, G2) ou enseignement moral et civique (EMC1, ..., EMC4). Ils sont assez larges:

- H1 La France de la Révolution française à la Ve République
- H2 La France et la construction européenne depuis 1950
- G1 Transports et mobilités
- G2 Espaces urbains : acteurs et enjeux
- EMC1 Être citoyen
- EMC2 La protection des libertés : défense et sécurité
...
- [EMC1 Être citoyen](./EMC_Etre_citoyen.pdf)
  - [Mes notes pour la fiche EMC1](./EMC_Etre_citoyen_notes.pdf)
- [EMC2 La protection des libertés : défense et sécurité](./EMC_La_protection_des_libertés_défense_sécurité_document.pdf)
  - [Mes notes pour la fiche EMC2](./EMC_La_protection_des_libertés_défense_sécurité_document_notes.pdf)
- [EMC3 La Liberté, nos libertés, ma liberté](./EMC_La_Liberté_nos_libertés_ma_liberté.pdf)
  - [Mes notes pour la fiche EMC3](./EMC_La_Liberté_nos_libertés_ma_liberté_notes.pdf)
- [EMC4 La laïcité](./EMC_La_laïcité.pdf)
  - [Mes notes pour la fiche EMC4](./EMC_La_laïcité_notes.pdf)
